...
JavaScript dynamically typed hai — variable ka type runtime par pata chalta hai:
...
Next.js TypeScript **already included** — just use `.ts` and `.tsx` files. No install needed.
