...
*How to implement authentication — Clerk and NextAuth v5 (Auth.js)*

---

## Auth Landscape

**Don't build authentication yourself** — it's a security minefield. Session management, password hashing, CSRF protection, brute-force prevention — all of this is handled by proven libraries.
...
`NEXT_PUBLIC_` prefix makes env vars visible in the client-side bundle:
